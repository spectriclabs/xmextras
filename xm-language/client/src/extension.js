...
function activate(context) {
    return __awaiter(this, void 0, void 0, function () {
        var serverModule, serverOptions, clientOptions, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console = __assign(__assign({}, console), { log: function (msg) {
                            var params = [];
                            for (var _i = 1; _i < arguments.length; _i++) {
                                params[_i - 1] = arguments[_i];
                            }
                            client.info("[Client]: ".concat(msg));
                        }, info: function (msg) {
                            var params = [];
                            for (var _i = 1; _i < arguments.length; _i++) {
                                params[_i - 1] = arguments[_i];
                            ...
                            client.warn("[Client]: ".concat(msg));
                        }, error: function (msg) {
                            var params = [];
                            for (var _i = 1; _i < arguments.length; _i++) {
                                params[_i - 1] = arguments[_i];
                            }
                            client.error("[Client]: ".concat(msg));
                        } });
